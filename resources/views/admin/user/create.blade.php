              ...
              <form action="{{route('store_user')}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukan Nama Lengkap" value="{{old('name')}}" name="name">
                    @error('name')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="Masukkan Nama Pengguna" value="{{old('username')}}" name="username">
                    @error('username')
                  ...
                  <div id="peserta_wa" class="form-group">
                    ...
                    <input type="number" class="form-control @error('no_wa') is-invalid @enderror" id="no_wa" placeholder="Masukkan Nomor Whatsapp" value="{{old('no_wa')}}" name="no_wa">
                    @error('no_wa')
